...
def load_fold(fold_number):
    train_index = np.load('../Data/folds/train_index_fold' + str(fold_number) + '.npy')
    test_index = np.load('../Data/folds/test_index_fold' + str(fold_number) + '.npy')
